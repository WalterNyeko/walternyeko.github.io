      ...
      init = function() {
        config.$bookBlock.bookblock({
          ...
          onEndFlip: function(old, page, isLimit) {
            ...
            $(".bb-item")
              .eq(page)
              .find(".works-container")
              .trigger({ type: "initWorks", test: true, name: "initWorks" });
          }
        });
        initEvents();
      },
  ...
  function elementInView() {
    ...
    $window.on("scroll resize", function() {
      ...
      $.each($animatedElements, function() {
        ...
        if (
          elementBottPosition >= windowTopPosition &&
  ...
  $(document).ready(function() {
    ...
    if ($(window).width() > 991) {
      ...
      $(".bb-custom-side").each(function() {
        $(this).append(
          '<div class="bb-custom-side-space-top"></div><div class="bb-custom-side-space-bottom"></div>'
        );
      });
